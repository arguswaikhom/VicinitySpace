...
import com.vicinityspace.WeatherApplication
...
import com.vicinityspace.ui.viewmodel.WeatherVMFactory
...
class WeatherActivity : AppCompatActivity() {
    ...
    private val weatherViewModel: WeatherViewModel by viewModels {
        WeatherVMFactory((application as WeatherApplication).weatherRepository)
    }
